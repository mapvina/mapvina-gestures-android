...
import io.github.mapvina.android.gestures.testapp.R
import io.github.mapvina.android.gestures.testapp.TestActivity
...
class ScaleGestureDetectorTest {
  ...
  fun onScaleBegin_doNotStart_thresholdNotMet() {
    ...
    val startSpan = 250f
    val threshold = activityTestRule.activity.resources.getDimension(io.github.mapvina.android.R.dimen.mapbox_defaultScaleSpanSinceStartThreshold)
  ...
  fun onScaleBegin_doNotStart_minSpanNotMet() {
    ...
    val threshold: Float = if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
      activityTestRule.activity.resources.getDimension(io.github.mapvina.android.R.dimen.mapbox_internalMinSpan23)
    } else {
      activityTestRule.activity.resources.getDimension(io.github.mapvina.android.R.dimen.mapbox_internalMinSpan24)
    }
